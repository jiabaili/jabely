package com.jabely.biz.order.dao.domain.query;
 ...
 *
 */
public class QueryOrderInfoDO extends QueryBaseDO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8395574457021673277L;
